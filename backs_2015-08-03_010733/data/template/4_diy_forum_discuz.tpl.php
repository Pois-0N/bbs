<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('discuz');?><?php include template('common/header'); ?><script src="template/win8mi_1st_huxiu/src/js/superslide.2.1.js" type="text/javascript"></script>
        ...
        <div id="category_0" class="bm_c" style="<?php echo $collapse['category_0']; ?>">
          <table cellspacing="0" cellpadding="0" class="fl_tb">
            ...
            <tr class="fl_row">
              ...
              <td><h2><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a>
                  <?php if($forum['todayposts'] && !$forum['redirect']) { ?>
                  <em class="xw0 xi1" title="今日"> (<?php echo $forum['todayposts'];?>)</em>
                  <?php } ?>
                </h2>
              ...
              <td class="fl_i"><div>
                  ...
                  <?php echo dnumber($forum['threads']); ?>                  </span>
                  <div class="line"> / </div>
                  <span class="f_posts">
          ...
          <table cellspacing="0" cellpadding="0" class="fl_tb">
            ...
            <tr class="fl_row">
              ...
              <td class="fl_i"><div>
                  <?php if(empty($forum['redirect'])) { ?>
                  <span class="f_threads">
                  <?php echo dnumber($forum['threads']); ?>                  </span><span class="line"> / </span><span class="f_posts">
                  <?php echo dnumber($forum['posts']); ?>                  </span>
                  <?php } ?>
                </div></td>
              <td class="fl_by"><div>
...
<?php if($_G['group']['radminid'] == 1) { helper_manyou::checkupdate();?><?php } if(empty($_G['setting']['disfixednv_forumindex']) ) { ?>
