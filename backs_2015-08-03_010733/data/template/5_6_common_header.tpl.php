...
0
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/header_common.htm', 1438369080, '6', './data/template/5_6_common_header.tpl.php', './template/newry_duitang', 'common/header')
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/pubsearchform.htm', 1438369080, '6', './data/template/5_6_common_header.tpl.php', './template/newry_duitang', 'common/header')
;?>
