...
0
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/header_common.htm', 1438529358, '6', './data/template/5_6_common_header_member_register.tpl.php', './template/newry_duitang', 'common/header_member_register')
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/pubsearchform.htm', 1438529358, '6', './data/template/5_6_common_header_member_register.tpl.php', './template/newry_duitang', 'common/header_member_register')
;?>
