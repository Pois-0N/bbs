...
0
|| checktplrefresh('./template/default/member/register.htm', './template/default/common/seccheck.htm', 1438529358, '6', './data/template/5_6_member_register.tpl.php', './template/newry_duitang', 'member/register')
