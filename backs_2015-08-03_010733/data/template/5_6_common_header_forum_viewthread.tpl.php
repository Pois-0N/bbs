...
0
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/header_common.htm', 1438316619, '6', './data/template/5_6_common_header_forum_viewthread.tpl.php', './template/newry_duitang', 'common/header_forum_viewthread')
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/pubsearchform.htm', 1438316619, '6', './data/template/5_6_common_header_forum_viewthread.tpl.php', './template/newry_duitang', 'common/header_forum_viewthread')
;?>
...
<?php } ?>    <div class="cl"></div>
  ...
  <script src="template/newry_duitang/style/js/scrolltop.js" type="text/javascript" ></script>
  <!--End Navigation-->
