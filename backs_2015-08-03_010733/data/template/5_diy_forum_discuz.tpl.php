<?php if(!defined('IN_DISCUZ')) exit('Access Denied'); hookscriptoutput('discuz');?><?php include template('common/header'); ?></div>
<style type="text/css">
...
<!--[diy=diy_n1]--><div id="diy_n1" class="area"></div><!--[/diy]-->
...
<div class="left_wrap">
   <div class="con">
     <!--[diy=diy_left2]--><div id="diy_left2" class="area"></div><!--[/diy]--> 
   </div>
</div>  
