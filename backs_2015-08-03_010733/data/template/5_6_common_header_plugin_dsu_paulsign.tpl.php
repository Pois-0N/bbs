...
0
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/header_common.htm', 1438529285, '6', './data/template/5_6_common_header_plugin_dsu_paulsign.tpl.php', './template/newry_duitang', 'common/header_plugin_dsu_paulsign')
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/pubsearchform.htm', 1438529285, '6', './data/template/5_6_common_header_plugin_dsu_paulsign.tpl.php', './template/newry_duitang', 'common/header_plugin_dsu_paulsign')
;?>
