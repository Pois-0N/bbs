...
0
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/header_common.htm', 1438564705, '6', './data/template/5_6_common_header_forum_index.tpl.php', './template/newry_duitang', 'common/header_forum_index')
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/pubsearchform.htm', 1438564705, '6', './data/template/5_6_common_header_forum_index.tpl.php', './template/newry_duitang', 'common/header_forum_index')
;?>
