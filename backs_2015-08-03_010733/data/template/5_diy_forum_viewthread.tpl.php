...
0
|| checktplrefresh('./template/newry_duitang/forum/viewthread.htm', './template/default/forum/viewthread_node.htm', 1438316618, 'diy', './data/template/5_diy_forum_viewthread.tpl.php', './template/newry_duitang', 'forum/viewthread')
|| checktplrefresh('./template/newry_duitang/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1438316618, 'diy', './data/template/5_diy_forum_viewthread.tpl.php', './template/newry_duitang', 'forum/viewthread')
|| checktplrefresh('./template/newry_duitang/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1438316618, 'diy', './data/template/5_diy_forum_viewthread.tpl.php', './template/newry_duitang', 'forum/viewthread')
|| checktplrefresh('./template/newry_duitang/forum/viewthread.htm', './template/default/common/seditor.htm', 1438316618, 'diy', './data/template/5_diy_forum_viewthread.tpl.php', './template/newry_duitang', 'forum/viewthread')
|| checktplrefresh('./template/newry_duitang/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1438316618, 'diy', './data/template/5_diy_forum_viewthread.tpl.php', './template/newry_duitang', 'forum/viewthread')
|| checktplrefresh('./template/newry_duitang/forum/viewthread.htm', './template/default/common/upload.htm', 1438316618, 'diy', './data/template/5_diy_forum_viewthread.tpl.php', './template/newry_duitang', 'forum/viewthread')
|| checktplrefresh('./template/newry_duitang/forum/viewthread.htm', './template/default/common/seccheck.htm', 1438316618, 'diy', './data/template/5_diy_forum_viewthread.tpl.php', './template/newry_duitang', 'forum/viewthread')
...
<a id="post_reply" class="ui_button" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复">回复</a>
<?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_postbutton_top'])) echo $_G['setting']['pluginhooks']['viewthread_postbutton_top'];?>
</div>

<?php if($_G['group']['allowpost'] && ($_G['group']['allowposttrade'] || $_G['group']['allowpostpoll'] || $_G['group']['allowpostreward'] || $_G['group']['allownewryActivity'] || $_G['group']['allowpostdebate'] || $_G['setting']['threadplugins'] || $_G['forum']['threadsorts'])) { ?>
...
<div id="postlist" class="pl bm newry_left" style="width:860px">
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_title_extra'])) echo $_G['setting']['pluginhooks']['viewthread_title_extra'];?>
             ...
             <?php if(!$close_leftinfo) { ?>
<div class="pls ptn pbn" style="background:none">
<?php if($_G['page'] > 1) { ?>
...
<div class="newry_right">
    ...
    <div id="newry_act" style="">
    <div class="bm xm_bm newry_act">
                <div class="bm_c">
                    <ul>
                        <li class="a1">
                       ...
                       <li class="a2">
                            ...
                            <a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>&amp;formhash=<?php echo FORMHASH;?>" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('favoritenumber').innerHTML + ' 人收藏'" title="收藏本帖">收藏</a>
                            
                        </li>
                        <li class="a3" style="border-right:none">
                                <a href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);" title="转播求扩散">转播</a>
                        ...
                        (function(){
                            var newryAct = document.getElementById("newry_act");
                            var newryActTop = newryAct.offsetTop;
                            document.onscroll = function() {
                                var docTop = document.body.scrollTop | document.documentElement.scrollTop;
                                if (newryActTop < (docTop + 100)) {
                                    newryAct.setAttribute("style", "position:fixed; top: 68px; z-index:300;box-shadow: 0 0 5px 2px rgba(0, 0, 0, 0.3);");
                                } else {
                                    newryAct.setAttribute("style", "");
                                }
                            }
                        })()
                    </script>
