...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1438366769, '6', './data/template/5_6_member_login.tpl.php', './template/newry_duitang', 'member/login')
