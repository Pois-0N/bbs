...
0
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/header_common.htm', 1438368309, '6', './data/template/5_6_common_header_home_task.tpl.php', './template/newry_duitang', 'common/header_home_task')
|| checktplrefresh('./template/newry_duitang/common/header.htm', './template/newry_duitang/common/pubsearchform.htm', 1438368309, '6', './data/template/5_6_common_header_home_task.tpl.php', './template/newry_duitang', 'common/header_home_task')
;?>
