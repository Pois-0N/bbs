...
0
|| checktplrefresh('./template/win8mi_1st_huxiu/common/header.htm', './template/win8mi_1st_huxiu/common/header_common.htm', 1438243055, '5', './data/template/4_5_common_header_portal_portalcp.tpl.php', './template/win8mi_1st_huxiu', 'common/header_portal_portalcp')
|| checktplrefresh('./template/win8mi_1st_huxiu/common/header.htm', './template/win8mi_1st_huxiu/common/pubsearchform.htm', 1438243055, '5', './data/template/4_5_common_header_portal_portalcp.tpl.php', './template/win8mi_1st_huxiu', 'common/header_portal_portalcp')
;?>
...
<?php } ?>
<link rel="stylesheet" type="text/css" href="template/win8mi_1st_huxiu/src/css/index.css" media="all">
...
<div class="top"> 
 <div class="top-box">
    ...
    <div id="header_user">
      <ul id="header_nav">
        <li id="shopping_cart"> <span><a href="home.php?mod=space&amp;do=pm" id="pm_ntc"<?php if($_G['member']['newpm']) { ?> class="new"<?php } ?>>æ¶ˆæ¯ 
          <?php if($_G['member']['newpm']) { ?> 
          (<?php echo $_G['member']['newpm'];?>) 
          <?php } ?> 
          </a></span>
          <div  id="newprompter" style="float: left;"><span><a href="home.php?mod=space&amp;do=notice" id="myprompt"<?php if($_G['member']['newprompt']) { ?> class="new"<?php } ?>>æé†’ 
            <?php if($_G['member']['newprompt']) { ?> 
            (<?php echo $_G['member']['newprompt'];?>) 
            <?php } ?> 
            </a></span></div>
          <?php if($_G['setting']['taskon'] && !empty($_G['cookie']['taskdoing_'.$_G['uid']])) { ?> 
          <span><a href="home.php?mod=task&amp;item=doing" id="task_ntc" class="new">è¿›è¡Œä¸­çš„ä»»åŠ¡</a></span> 
          <?php } ?> 
          <span class="avatarimg" style="padding-right: 7px; background: url(template/win8mi_1st_huxiu/src/img/ardown.png) no-repeat 40px center;"> <a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" target="_blank" title="è®¿é—®æˆ‘çš„ç©ºé—´" id="umnav" class="username" onMouseOver="showMenu({'ctrlid':this.id,'ctrlclass':'a'})"> 
    ...
    <div id="header_user">
      <ul id="header_nav">
        <li id="shopping_cart"> <span><a id="loginuser" class="username"> 
          ...
          </a></span> <span><a href="member.php?mod=logging&amp;action=login" onClick="showWindow('login', this.href)">æ¿€æ´»</a></span> <span><a href="member.php?mod=logging&amp;action=logout&amp;formhash=<?php echo FORMHASH;?>">é€€å‡º</a></span> </li>
      </ul>
    </div>
    <?php } elseif(!$_G['connectguest']) { ?>
    <div id="header_user">
      <ul id="header_nav">
        <li class="login_list" style="width: 35px;"><a href="xwb.php?m=xwbAuth.login"><i class="i_wb">Î¢²©µÇÂ¼</i></a></li>
        <li class="login_list"><a href="connect.php?mod=login&amp;op=init&amp;referer=forum.php&amp;statfrom=login"><i class="i_qq">ÌÚÑ¶QQ</i></a></li>
        <li class="login_list" style="_width: 75px;"><a class="login_block"  href="member.php?mod=register" class="btn-register">Á¢¼´×¢²á</a></li>
        <li class="login_list" style="_width: 45px;"><a class="login_block"  href="javascript:;" onClick="javascript:lsSubmit();" class="nousername">µÇÂ¼</a></li>
      </ul>
    </div>
    ...
    <div id="header_user">
      <ul id="header_nav">
        <li id="shopping_cart"> <span><a href="home.php?mod=spacecp&amp;ac=usergroup" class="nousername"><?php echo $_G['member']['username'];?></a></span> <span><a href="member.php?mod=logging&amp;action=logout&amp;formhash=<?php echo FORMHASH;?>">é€€å‡º</a></span> </li>
      </ul>
    </div>
    <?php } ?> 
    <!-- /Block user information module HEADER -->
...
<td class="scbar_type_td"><a href="javascript:;" id="scbar_type" class="xg1" onclick="showMenu(this.id)" hidefocus="true">æœç´¢</a></td>                
<td class="scbar_btn_td"><button type="submit" name="searchsubmit" id="scbar_btn" sc="1" class="pn pnc" value="true"><strong class="xi2">æœç´¢</strong></button></td>
</tr>
</table>
</form>
</div>
...
<?php } ?>    </div>
</div><?php echo adshow("headerbanner/wp a_h");?><?php echo adshow("subnavbanner/a_mu");?> 
<?php if(!empty($_G['setting']['pluginhooks']['global_header'])) echo $_G['setting']['pluginhooks']['global_header'];?>
<?php } ?>

<div class="row-fluid-wrap-hx">
 <div class="center-container-hx">
  <div class="row-fluid-hx cl">