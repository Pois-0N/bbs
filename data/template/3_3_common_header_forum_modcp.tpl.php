...
0
|| checktplrefresh('./template/df_meizu_141003/common/header.htm', './template/default/common/header_common.htm', 1448764802, '3', './data/template/3_3_common_header_forum_modcp.tpl.php', './template/df_meizu_141003', 'common/header_forum_modcp')
|| checktplrefresh('./template/df_meizu_141003/common/header.htm', './template/df_meizu_141003/common/pubsearchform.htm', 1448764802, '3', './data/template/3_3_common_header_forum_modcp.tpl.php', './template/df_meizu_141003', 'common/header_forum_modcp')
|| checktplrefresh('./template/df_meizu_141003/common/header.htm', './template/default/common/header_qmenu.htm', 1448764802, '3', './data/template/3_3_common_header_forum_modcp.tpl.php', './template/df_meizu_141003', 'common/header_forum_modcp')
;?>
...
<?php } ?>
    <script src="<?php echo $_G['style']['styleimgdir'];?>/tools.js" type="text/javascript"></script>
<script type="text/javascript">
        var jq=jQuery.noConflict();
    </script>
    <script src="<?php echo $_G['style']['styleimgdir'];?>/index.js" type="text/javascript"></script>
    <script src="<?php echo $_G['style']['styleimgdir'];?>/slides.js" type="text/javascript" type="text/javascript"></script>
...
</div><?php } ?><?php echo adshow("headerbanner/wp a_h");?>        
<div id="deanheader">
<div class="deanwp">
            <?php $mnid = getcurrentnav();?>            	<div class="deanlogo">
...
<?php if(!empty($_G['setting']['pluginhooks']['global_nav_extra'])) echo $_G['setting']['pluginhooks']['global_nav_extra'];?>
                ...
                <div class="deandenglu"><?php include template('common/header_userstatus'); ?></div>
                <div class="clear"></div>
</div>
</div>
<script src="<?php echo $_G['style']['styleimgdir'];?>/nv1.js" type="text/javascript"></script>
        <div class="clear"></div>
