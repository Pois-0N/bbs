...
0
|| checktplrefresh('data/diy/./template/df_meizu_141003//portal/view_1.htm', './template/default/portal/portal_comment.htm', 1448016734, 'diy', './data/template/3_diy_portal_view_1.tpl.php', 'data/diy/./template/df_meizu_141003/', 'portal/view_1')
|| checktplrefresh('data/diy/./template/df_meizu_141003//portal/view_1.htm', './template/default/common/seccheck.htm', 1448016734, 'diy', './data/template/3_diy_portal_view_1.tpl.php', 'data/diy/./template/df_meizu_141003/', 'portal/view_1')
;
block_get('260,261,262,263,264,265,266');?><?php include template('common/header'); ?><script src="<?php echo $_G['setting']['jspath'];?>forum_viewthread.js?<?php echo VERHASH;?>" type="text/javascript"></script>
            ...
            <div class="deanp14">
                ...
                <div class="deantabs top25">
                    ...
                    <ul class="deantabc top15">
                        <li style="display:block;"><!--[diy=deantabc1]--><div id="deantabc1" class="area"><div id="frameQEN4NY" class="frame move-span cl frame-1"><div id="frameQEN4NY_left" class="column frame-1-c"><div id="frameQEN4NY_left_temp" class="move-span temp"></div><?php block_display('260');?></div></div></div><!--[/diy]--></li>
                        <li><!--[diy=deantabc2]--><div id="deantabc2" class="area"><div id="frameur23bG" class="frame move-span cl frame-1"><div id="frameur23bG_left" class="column frame-1-c"><div id="frameur23bG_left_temp" class="move-span temp"></div><?php block_display('261');?></div></div></div><!--[/diy]--></li>
                    </ul>
                </div>
                <div class="deanactive top25">
                    <h2>最新活动</h2>
                    <div class="clear"></div>
                    <ul><!--[diy=deanactive]--><div id="deanactive" class="area"><div id="framex8qmzO" class="frame move-span cl frame-1"><div id="framex8qmzO_left" class="column frame-1-c"><div id="framex8qmzO_left_temp" class="move-span temp"></div><?php block_display('262');?></div></div></div><!--[/diy]--></ul>
                </div>
                <div class="clear"></div>
                <div class="clear"></div>
                <div class="deanrank top25">
                    <h2>文章排行榜</h2>
                    <div class="clear"></div>
                    <ul class="deanrankc"><!--[diy=deanrank]--><div id="deanrank" class="area"><div id="frameQq3bi3" class="frame move-span cl frame-1"><div id="frameQq3bi3_left" class="column frame-1-c"><div id="frameQq3bi3_left_temp" class="move-span temp"></div><?php block_display('263');?></div></div></div><!--[/diy]--></ul>
                </div>
                <div class="clear"></div>
                <div class="deannewdp top25">
                    <h2>文章热图</h2>
                    <div class="clear"></div>
                    <div class="deannewdpc"><!--[diy=deannewdpc]--><div id="deannewdpc" class="area"><div id="framewcrVCj" class="frame move-span cl frame-1"><div id="framewcrVCj_left" class="column frame-1-c"><div id="framewcrVCj_left_temp" class="move-span temp"></div><?php block_display('264');?></div></div></div><!--[/diy]--></div>
                </div>
                <div class="clear"></div>  
                <div class="deantabs top25">
                    <ul class="deantabname">
                    ...
                    <div class="clear"></div>
                    <ul class="deantabc top15">
                        <li style="display:block;"><!--[diy=deantabc3]--><div id="deantabc3" class="area"><div id="frameae66Ih" class="frame move-span cl frame-1"><div id="frameae66Ih_left" class="column frame-1-c"><div id="frameae66Ih_left_temp" class="move-span temp"></div><?php block_display('265');?></div></div></div><!--[/diy]--></li>
                        <li style="text-align:center;"><!--[diy=deantabc4]--><div id="deantabc4" class="area"><div id="frameknT8Tl" class="frame move-span cl frame-1"><div id="frameknT8Tl_left" class="column frame-1-c"><div id="frameknT8Tl_left_temp" class="move-span temp"></div><?php block_display('266');?></div></div></div><!--[/diy]--></li>
                    </ul>
                </div>
...
<div class="wp mtn">
<!--[diy=diy3]--><div id="diy3" class="area"><div id="frameo8cvdd" class="frame move-span cl frame-1"><div class="title frame-title"><span class="titletext">1框架</span></div><div id="frameo8cvdd_left" class="column frame-1-c"><div id="frameo8cvdd_left_temp" class="move-span temp"></div></div></div></div><!--[/diy]-->
</div>
