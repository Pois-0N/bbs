...
0
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/viewthread.htm', './template/df_meizu_141003/forum/viewthread_node.htm', 1447998128, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1447998128, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1447998128, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1447998128, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/viewthread.htm', './template/default/common/seditor.htm', 1447998128, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1447998128, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/viewthread.htm', './template/default/common/upload.htm', 1447998128, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/viewthread')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/viewthread.htm', './template/default/common/seccheck.htm', 1447998128, 'diy', './data/template/3_diy_forum_viewthread.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/viewthread')
;
block_get('292,293,294,295,296,297,298,299,300');?><?php include template('common/header'); ?><script type="text/javascript">var fid = parseInt('<?php echo $_G['fid'];?>'), tid = parseInt('<?php echo $_G['tid'];?>');</script>
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_postheader'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_postheader'][$postcount];?>
        ...
        <div class="y">
        	<div class="hm ptn">
            	<span class="y replies"><?php echo $_G['forum_thread']['allreplies'];?></span>
                <span class="y views"><?php echo $_G['forum_thread']['views'];?></span>
                <div class="clear"></div>
            </div>
        </div>
        <div class="clear"></div>
...
<div id="fj" class="y">
                    	<span class="deanactbtn y" style=" width:24px;">
                        	<a href="home.php?mod=spacecp&amp;ac=favorite&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" id="k_favorite" onclick="showWindow(this.id, this.href, 'get', 0);" onmouseover="this.title = $('favoritenumber').innerHTML + ' 人收藏'" title="收藏本帖"><img src="<?php echo $_G['style']['styleimgdir'];?>/pl_t_fav.gif" alt="收藏" />	</a>
                        </span>
                        <span class="deanactbtn y" style=" width:58px;">
...
<a href="javascript:;" id="fj_btn" class="z" title="跳转到指定楼层"><img src="<?php echo $_G['style']['styleimgdir'];?>/pl_t_fj.gif" alt="跳转到指定楼层" class="vm" /></a>
                        </span>
<div class="clear"></div>
</div>
<?php } if($post['warned']) { ?>
...
<?php if(!($_G['setting']['threadguestlite'] && !$_G['uid'])) { if($post['authorid'] != $_G['uid']) { ?>
<ul class="xl xl2 o cl">
                            <li class="space"><a href="forum.php?mod=modcp&amp;action=thread&amp;op=post&amp;do=search&amp;searchsubmit=1&amp;users=<?php echo $post['usernameenc'];?>" target="_blank">帖子</a></li>
...
<div class="pi"<?php if($close_leftinfo && !$post['anonymous'] && $postshowavatars && $showavatars) { ?> style="height:48px"<?php } ?>>
        	<?php if($_G['setting']['authoronleft']) { ?>
                    <div class="authi deanauthor" style=" display:inline-block;"><a href="home.php?mod=space&amp;uid=<?php echo $post['authorid'];?>" target="_blank" class="xw1"<?php if($post['groupcolor']) { ?> style="color: <?php echo $post['groupcolor'];?>"<?php } ?>><?php echo $post['author'];?></a><?php echo $authorverifys;?></div>
            <?php } if(!IS_ROBOT) { if(!$postcount && !$_G['forum_thread']['archiveid'] && $post['first'] ) { ?>
<div id="fj" class="y">
...
<?php if(!empty($_G['setting']['pluginhooks']['viewthread_endline'][$postcount])) echo $_G['setting']['pluginhooks']['viewthread_endline'][$postcount];?>
    ...
    <?php $nxtpage = $page + 1;?>        <div class="pgbtn"><a id="viewautopbn" href="forum.php?mod=viewthread&amp;tid=<?php echo $_G['tid'];?><?php if($_GET['authorid']) { ?>&amp;authorid=<?php echo $_GET['authorid'];?><?php } ?>&amp;page=<?php echo $nxtpage;?>" hidefocus="true" class="bm_h">下一页 &raquo;</a></div>
    <?php } ?>
...
<?php } ?>
    ...
    <div class="sd" style=" width:304px; float:right; overflow:hidden;">
   		<div class="postact" id="deanpostact">
            <div class="deanqd" style="width:304px;">
                <a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖">发布主题</a>
            </div>
            <div class="bm_c">
            	<ul>
                	<li class="a1">
                        <?php if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
                         ...
                         <?php } else { ?>
                         	<span id="nopostreply">回复</span>
                         <?php } ?>
            		</li>
                    <li class="a2">
                    	<?php if(!$post['anonymous'] && helper_access::check_module('follow')) { ?>
<a class="followp" href="home.php?mod=spacecp&amp;ac=follow&amp;op=relay&amp;tid=<?php echo $_G['tid'];?>&amp;from=forum" onclick="showWindow('relaythread', this.href, 'get', 0);" title="转播求扩散"><i>转播<?php if($_G['forum_thread']['relay']) { ?><span id="relaynumber" style="display:none"><?php echo $_G['forum_thread']['relay'];?></span><?php } ?></i></a>
                        <?php } else { ?>
                         	<span id="nocmmnt">转播</span>
                        <?php } ?>
                    </li>
                    <li class="a3">
                    	<?php if($_G['group']['raterange'] && $post['authorid']) { ?>
<a href="javascript:;" id="ak_rate" onclick="showWindow('rate', 'forum.php?mod=misc&action=rate&tid=<?php echo $_G['tid'];?>&pid=<?php echo $post['pid'];?>', 'get', -1);return false;" title="评分表立场"><i>评分</i></a>
<?php } else { ?>
                    	<span id="nopingfen">评分</span>
                        <?php } ?>
                    </li>
                    <li class="a4" style="border-right:none;">
                    	<?php if(helper_access::check_module('share')) { ?>
<a class="sharep" href="home.php?mod=spacecp&amp;ac=share&amp;type=thread&amp;id=<?php echo $_G['tid'];?>" onclick="showWindow('sharethread', this.href, 'get', 0);" title="分享推精华"><i>分享<?php if($_G['forum_thread']['sharetimes']) { ?><span id="sharenumber"><?php echo $_G['forum_thread']['sharetimes'];?></span><?php } ?></i></a>
                        <?php } else { ?>
                        <span id="noshare">分享</span>
<?php } ?>
                    </li>
                    <div class="clear"></div>
                </ul>
                ...
                <div class="deanwprc deanshadow deanborder deanfff">
                    <div class="deanp14">
                        ...
                        <div class="deanactive top25">
                            <h2>最新活动</h2>
                            <div class="clear"></div>
                            <ul><!--[diy=deanactive]--><div id="deanactive" class="area"><div id="framejzJB8Z" class="frame move-span cl frame-1"><div id="framejzJB8Z_left" class="column frame-1-c"><div id="framejzJB8Z_left_temp" class="move-span temp"></div><?php block_display('292');?></div></div></div><!--[/diy]--></ul>
                        </div>
                        <div class="clear"></div>
                        <div class="deantabs top25">
                            ...
                            <ul class="deantabc top15">
                                <li style="display:block;"><!--[diy=deantabc1]--><div id="deantabc1" class="area"><div id="framezq5J3t" class="frame move-span cl frame-1"><div id="framezq5J3t_left" class="column frame-1-c"><div id="framezq5J3t_left_temp" class="move-span temp"></div><?php block_display('293');?></div></div></div><!--[/diy]--></li>
                                <li><!--[diy=deantabc2]--><div id="deantabc2" class="area"><div id="framelxPsFR" class="frame move-span cl frame-1"><div id="framelxPsFR_left" class="column frame-1-c"><div id="framelxPsFR_left_temp" class="move-span temp"></div><?php block_display('294');?></div></div></div><!--[/diy]--></li>
                            </ul>
                        ...
                        <div class="deanrank top25">
                            <h2>排行榜</h2>
                            <div class="clear"></div>
                            <ul class="deanrankc"><!--[diy=deanrank]--><div id="deanrank" class="area"><div id="frameM6eUAQ" class="frame move-span cl frame-1"><div id="frameM6eUAQ_left" class="column frame-1-c"><div id="frameM6eUAQ_left_temp" class="move-span temp"></div><?php block_display('295');?></div></div></div><!--[/diy]--></ul>
                        </div>
                        <div class="clear"></div>
                        <div class="deannewdp top25">
                            <h2>随手拍</h2>
                            <div class="clear"></div>
                            <div class="deannewdpc"><!--[diy=deannewdpc]--><div id="deannewdpc" class="area"><div id="frameSFFF9G" class="frame move-span cl frame-1"><div id="frameSFFF9G_left" class="column frame-1-c"><div id="frameSFFF9G_left_temp" class="move-span temp"></div><?php block_display('296');?></div></div></div><!--[/diy]--></div>
                        </div>
                        <div class="clear"></div>
                        <div class="deannewzd top25">
                            <h2>新手学院</h2>
                            <div class="clear"></div>
                            <div class="deannewzdc"><!--[diy=deannewzdc]--><div id="deannewzdc" class="area"><div id="framexlM23I" class="frame move-span cl frame-1"><div id="framexlM23I_left" class="column frame-1-c"><div id="framexlM23I_left_temp" class="move-span temp"></div><?php block_display('297');?></div></div></div><!--[/diy]--></div>
                            <div class="clear"></div>
                            <ul class="top15"><!--[diy=deannewzdc1]--><div id="deannewzdc1" class="area"><div id="framekv69sP" class="frame move-span cl frame-1"><div id="framekv69sP_left" class="column frame-1-c"><div id="framekv69sP_left_temp" class="move-span temp"></div><?php block_display('298');?></div></div></div><!--[/diy]--></ul>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="deantabs top25">
                            ...
                            <div class="clear"></div>
                            <ul class="deantabc top15">
                                <li style="display:block;"><!--[diy=deantabc3]--><div id="deantabc3" class="area"><div id="frameQhA9Hn" class="frame move-span cl frame-1"><div id="frameQhA9Hn_left" class="column frame-1-c"><div id="frameQhA9Hn_left_temp" class="move-span temp"></div><?php block_display('299');?></div></div></div><!--[/diy]--></li>
                                <li style="text-align:center;"><!--[diy=deantabc4]--><div id="deantabc4" class="area"><div id="frameU3cr2T" class="frame move-span cl frame-1"><div id="frameU3cr2T_left" class="column frame-1-c"><div id="frameU3cr2T_left_temp" class="move-span temp"></div><?php block_display('300');?></div></div></div><!--[/diy]--></li>
                            </ul>
                        </div>
