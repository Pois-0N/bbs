...
<a href="#" target="_blank" class="txwb"></a>
<a href="#" target="_blank" class="sina"></a>
</div>
<div class="clear"></div>
<div class="deanftinfo">&copy;2014&nbsp;&nbsp;<a href="<?php echo $_G['setting']['siteurl'];?>" target="_blank"><?php echo $_G['setting']['sitename'];?></a>. All rights reserved. <?php if($_G['setting']['icp']) { ?>( <a href="http://www.miitbeian.gov.cn/" target="_blank"><?php echo $_G['setting']['icp'];?></a> )<?php } ?>&nbsp;&nbsp;Powered by <strong><a href="http://www.adminbuy.cn" target="_blank">AB模板网</a></strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?>&nbsp;&nbsp;技术支持：<a href="http://www.adminbuy.cn" target="_blank">discuz模板</a><?php if($_G['setting']['statcode']) { ?><?php echo $_G['setting']['statcode'];?><?php } ?></div>
</div>
<div id="ft" class="wp cl" style="padding:0; border:0;"><?php updatesession();?><?php if($_G['uid'] && $_G['group']['allowinvisible']) { ?>
<script type="text/javascript">
...
<?php } output();?><script type="text/javascript">
