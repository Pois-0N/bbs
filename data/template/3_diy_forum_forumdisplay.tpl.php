...
0
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1448005378, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1448005378, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1448005378, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/forumdisplay.htm', './template/df_meizu_141003/forum/forumdisplay_list.htm', 1448005378, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1448005378, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1448005378, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/forumdisplay')
|| checktplrefresh('data/diy/./template/df_meizu_141003//forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1448005378, 'diy', './data/template/3_diy_forum_forumdisplay.tpl.php', 'data/diy/./template/df_meizu_141003/', 'forum/forumdisplay')
;
block_get('283,284,285,286,287,288,289,290,291');?><?php include template('common/header'); if($_G['forum']['ismoderator']) { ?>
...
<th><?php if(empty($_G['forum']['picstyle']) && $_GET['orderby'] == 'lastpost' && !$_GET['filter']) { ?><a href="javascript:;" onclick="checkForumnew_btn('<?php echo $_G['fid'];?>')" title="查看更新" class="forumrefresh">版块主题</a><?php } else { ?>&nbsp;<?php } ?></th><td>&nbsp;</td>
</tr>
</tbody>
...
<?php } } ?>
                                            ...
                                            <div class="y">
                                            	<a style=" font-size:20px;color: #666; font-family:Georgia, 'Times New Roman', Times, serif; margin: 0 9px 0 5px; text-align:right; display:block;" href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>" class="xi2"><?php echo $thread['allreplies'];?></a>
                                            </div>
                                            <div class="clear"></div>
                                        </div>
                                        <div class="deanthb">
                                        <div class="z">
                                                ...
                                                <div class="deanforumdateline" style=" float:left;">
                                                    <span>&nbsp;于&nbsp;<span style="color:#aaa;"<?php if($thread['istoday']) { ?> class="xi1"<?php } ?>><?php echo $thread['dateline'];?></span></span><span><?php if($thread['typehtml']) { ?>&nbsp;发表在&nbsp;<?php echo $thread['typehtml'];?> <?php echo $thread['sorthtml'];?></span><?php } ?>
                                                </div>
                                                <div class="deanforumreply" style=" float:left;">
                                                    <span>&nbsp;最后回复 <a href="<?php if($thread['digest'] != -2 && !$thread['ordertype']) { ?>forum.php?mod=redirect&tid=<?php echo $thread['tid'];?>&goto=lastpost<?php echo $highlight;?>#lastpost<?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?><?php if(!$thread['ordertype']) { ?>&page=<?php echo max(1, $thread['pages']);; } } ?>"><?php echo $thread['lastpost'];?></a></span>
                                                    <cite style="display:inline-block;">by <?php if($thread['lastposter']) { ?><a href="<?php if($thread['digest'] != -2) { ?>home.php?mod=space&username=<?php echo $thread['lastposterenc'];?><?php } else { ?>forum.php?mod=viewthread&tid=<?php echo $thread['tid'];?>&page=<?php echo max(1, $thread['pages']);; } ?>" c="1"><?php echo $thread['lastposter'];?></a><?php } else { ?><?php echo $_G['setting']['anonymoustext'];?><?php } ?></cite>
                                            
                                                </div>
                                                <div class="clear"></div>
                                            </div>
                                            <div class="y">
                                            	<em style=" font-size:12px;color: #aaa;margin: 0 9px 0 5px; text-align:right; display:block; font-family:Georgia, 'Times New Roman', Times, serif; "><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></em>
                                            </div>
                                            <div class="clear"></div>
                                        </div>
...
<div id="pgbtn" class="pgbtn"><a class="bm_h" href="javascript:;" rel="<?php echo $multipage_more;?>" curpage="<?php echo $page;?>" id="autopbn" totalpage="<?php echo $maxpage;?>" picstyle="<?php echo $_G['forum']['picstyle'];?>" forumdefstyle="<?php echo $_G['cookie']['forumdefstyle'];?>">下一页 &raquo;</a></div>
...
<?php if(!$subforumonly) { ?>
            	<div class="deanqd" style="width:304px;"><a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖">发布主题</a></div>
                <?php if($moderatedby) { ?>
                <div class="bm top15 deanborder">
                	<div class="bm_h">版主</div>
                    <div class="bm_c"><span class="xi2"><?php echo $moderatedby;?></span></div>
                </div>
                <?php } ?>
            	<?php if($_G['page'] == 1 && $_G['forum']['rules']) { ?>
            	<div class="bm">
                	<div class="bm_h">
                   <span class="o z"><img id="forum_rules_<?php echo $_G['fid'];?>_img" src="<?php echo $_G['style']['styleimgdir'];?>/collapsed_<?php echo $collapse['forum_rulesimg'];?>.gif" title="收起/展开" alt="收起/展开" onclick="toggle_collapse('forum_rules_<?php echo $_G['fid'];?>')" /></span>
                    	<h2 class="z" style=" margin-left:10px;">版块规则</h2>
                        <div class="clear"></div>
                    </div>
                    <div class="bm_c">
<?php if($_G['page'] == 1 && $_G['forum']['rules']) { ?>
                ...
                <div class="deanwprc deanshadow deanborder deanfff">
                    <div class="deanp14">
                        ...
                        <div class="deanactive top25">
                            <h2>最新活动</h2>
                            <div class="clear"></div>
                            <ul><!--[diy=deanactive]--><div id="deanactive" class="area"><div id="frames1Crrm" class="frame move-span cl frame-1"><div id="frames1Crrm_left" class="column frame-1-c"><div id="frames1Crrm_left_temp" class="move-span temp"></div><?php block_display('283');?></div></div></div><!--[/diy]--></ul>
                        </div>
                        <div class="clear"></div>
                        <div class="deantabs top25">
                            ...
                            <ul class="deantabc top15">
                                <li style="display:block;"><!--[diy=deantabc1]--><div id="deantabc1" class="area"><div id="frameekdukw" class="frame move-span cl frame-1"><div id="frameekdukw_left" class="column frame-1-c"><div id="frameekdukw_left_temp" class="move-span temp"></div><?php block_display('284');?></div></div></div><!--[/diy]--></li>
                                <li><!--[diy=deantabc2]--><div id="deantabc2" class="area"><div id="framelRkclv" class="frame move-span cl frame-1"><div id="framelRkclv_left" class="column frame-1-c"><div id="framelRkclv_left_temp" class="move-span temp"></div><?php block_display('285');?></div></div></div><!--[/diy]--></li>
                            </ul>
                        ...
                        <div class="deanrank top25">
                            <h2>排行榜</h2>
                            <div class="clear"></div>
                            <ul class="deanrankc"><!--[diy=deanrank]--><div id="deanrank" class="area"><div id="frameqmMAke" class="frame move-span cl frame-1"><div id="frameqmMAke_left" class="column frame-1-c"><div id="frameqmMAke_left_temp" class="move-span temp"></div><?php block_display('286');?></div></div></div><!--[/diy]--></ul>
                        </div>
                        <div class="clear"></div>
                        <div class="deannewdp top25">
                            <h2>随手拍</h2>
                            <div class="clear"></div>
                            <div class="deannewdpc"><!--[diy=deannewdpc]--><div id="deannewdpc" class="area"><div id="frameaFMv2l" class="frame move-span cl frame-1"><div id="frameaFMv2l_left" class="column frame-1-c"><div id="frameaFMv2l_left_temp" class="move-span temp"></div><?php block_display('287');?></div></div></div><!--[/diy]--></div>
                        </div>
                        <div class="clear"></div>
                        <div class="deannewzd top25">
                            <h2>新手学院</h2>
                            <div class="clear"></div>
                            <div class="deannewzdc"><!--[diy=deannewzdc]--><div id="deannewzdc" class="area"><div id="frameesnZjj" class="frame move-span cl frame-1"><div id="frameesnZjj_left" class="column frame-1-c"><div id="frameesnZjj_left_temp" class="move-span temp"></div><?php block_display('288');?></div></div></div><!--[/diy]--></div>
                            <div class="clear"></div>
                            <ul class="top15"><!--[diy=deannewzdc1]--><div id="deannewzdc1" class="area"><div id="frameFN8nE8" class="frame move-span cl frame-1"><div id="frameFN8nE8_left" class="column frame-1-c"><div id="frameFN8nE8_left_temp" class="move-span temp"></div><?php block_display('289');?></div></div></div><!--[/diy]--></ul>
                        </div>
                        <div class="clear"></div>
                        ...
                        <div class="deantabs top25">
                            ...
                            <div class="clear"></div>
                            <ul class="deantabc top15">
                                <li style="display:block;"><!--[diy=deantabc3]--><div id="deantabc3" class="area"><div id="framew7vzOv" class="frame move-span cl frame-1"><div id="framew7vzOv_left" class="column frame-1-c"><div id="framew7vzOv_left_temp" class="move-span temp"></div><?php block_display('290');?></div></div></div><!--[/diy]--></li>
                                <li style="text-align:center;"><!--[diy=deantabc4]--><div id="deantabc4" class="area"><div id="frameNzEXzC" class="frame move-span cl frame-1"><div id="frameNzEXzC_left" class="column frame-1-c"><div id="frameNzEXzC_left_temp" class="move-span temp"></div><?php block_display('291');?></div></div></div><!--[/diy]--></li>
                            </ul>
                        </div>
