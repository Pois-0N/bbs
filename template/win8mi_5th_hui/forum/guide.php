...
<div class="boardnav">
	<div id="ct" class="wp cl{if $_G['forum']['allowside']} ct2{/if}"{if $leftside} style="margin-left:{$_G['leftsidewidth_mwidth']}px"{/if}>
		<div class="mn">
			<div class="bm bml pbn" style="margin-bottom: 20px;">
				<!--{if $view != 'my'}-->
			...
			<!--{if $view != 'index'}-->
			<div id="pgt" class="bm bw0 pgs cl" style="padding: 10px 0 0 15px;">
				$multipage
				<a onclick="showWindow('nav', this.href, 'get', 0)" href="forum.php?mod=misc&amp;action=nav"><img src="$_G['style'][styleimgdir]/pn_post.png" alt="{lang send_posts}" / style="background-color: #1DBD9D;"></a>
			</div>
			<!--{/if}-->
