...
<div class="boardnav">
	<div id="ct" class="wp cl{if $_G['forum']['allowside']} ct2{/if}"{if $leftside} style="margin-left:{$_G['leftsidewidth_mwidth']}px"{/if}>
		...
		<div class="mn animated fadeInUp">
			<div class="bm bml" style="padding: 10px 20px 5px 20px; margin-bottom: 20px;">
				<!--{if $_G[forum][banner] && !$subforumonly}--><img src="$_G[forum][banner]" alt="$_G['forum'][name]" style="width: 100%; margin-bottom: 5px;" /><!--{/if}-->
				<div class="bm_h cl" style="border-bottom: 0;">
                    ...
                    <span style="float: left;"><h1 class="xs2">
						<a href="forum.php?mod=forumdisplay&fid=$_G[fid]" style="font-size: 16px; font-family: 'Microsoft Yahei'; color: #555555;">$_G['forum'][name]</a>
		...
		<div class="sd">
			...
			<!--{if !$subforumonly}-->
				<div class="bm" style="margin: 0 0 20px 0;">
					<div class="bm_h" style="padding: 0 10px;">
						<h2 style="font-size: 14px;">{lang their}: <!--{eval echo cutstr($_G['cache']['forums'][$_G['forum']['fup']]['name'], 22, '')}--></h2>
					</div>
					<div class="bm_c" style="padding: 15px;">
						<ul class="xl xl2 cl">
						<!--{loop $_G['cache']['forums'] $bforum}-->
							<!--{if $bforum['fup'] == $_G['forum']['fup'] && $bforum['status']}-->
								<li style="width: 33%; margin: 0 0 10px 0; height: 26px; line-height: 26px;"><a href="forum.php?mod=forumdisplay&fid=$bforum[fid]" style="display: block; width: 80px; height: 26px; line-height: 26px; text-align: center; padding: 0; color: #FFFFFF; font-size: 13px; overflow: hidden; background: #1DBD9D;">$bforum['name']</a></li>
							<!--{/if}-->
						<!--{/loop}-->
						</ul>
					</div>
				...
				<!--{if $recommendgroups}-->
				<div class="bm">
					<div class="bm_h cl" style="padding: 0 10px;">
						<h2 style="font-size: 14px;">{lang recommended_groups}</h2>
					</div>
					<div class="bm_c cl" style="padding: 10px;">
						<ul class="ml mls cl">
						<!--{loop $recommendgroups $key $group}-->
							<li>
				...
				<!--{if !($_G['forum']['simple'] & 1) && $_G[setting][whosonlinestatus]}-->
					<div class="bm">
						...
						<div class="bm_h cl" style="padding: 0 10px;">
							...
							<h2 style="font-size: 14px;">{lang forum_activeusers} ($onlinenum)</h2>
						</div>
						<div class="bm_c" style="padding: 10px;">
							<ul class="ml mls cl">
