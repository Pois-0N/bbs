...
<div id="wrap">
<div id="head_top">
  <div class="head_top {if $_GET['diy'] == 'yes' && check_diy_perm($topic)}hide{/if}">
    <div class="wp1020 cl"> 
      ...
      <div class="userbox"> 
        <!--{if $_G['uid']}-->
        <ul class="usernav">
          <li class="user_list"><a id="nte_menu" href="home.php?mod=space&do=notice" class="user_link notification">提醒<!--{if $_G[member][newprompt]}--><span class="unread_num png">$_G[member][newprompt]</span><!--{/if}--></a> </li>
        ...
        <ul class="usernav user_part">
          <li class="user_list"><a href="https://www.ejiandai.com/login?redirectURL=%2Faccount%2Fforum" class="user_link login">{lang login}</a></li>
          <li class="user_list"><a href="https://www.ejiandai.com/register" class="user_link register">注册</a></li>
        </ul>
...
<div class="wp cl" style="padding: 85px 0 0 0; _padding: 20px;"> 
  <!-- 导航 -->
  <div class="nav_box">
    <div class="nav">
      <ul>
        ...
        <li {if $mnid == $nav[navid]}class="a" {/if}$nav[nav]><em></em></li>
        <!--{/if}--> 
        <!--{/loop}-->
      </ul>
  ...
  <div class="top_ad"><a id="top_adv" href="#"><img src="template/win8mi_5th_hui/src/ad/ad_top.jpg"></a></div>
</div>
