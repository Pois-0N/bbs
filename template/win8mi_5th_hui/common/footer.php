...
<div id="footer" class="cl">
  <div id="ft" class="wp cl">
    <div class="ftlogo cl"> <img src="template/win8mi_5th_hui/src/ftlogo.png" /> </div>
    <div class="widget-2 last widget">
     <div class="borders">
      <p> <a href="#">About us</a><span class="pipe">|</span> <a href="forum.php?mod=misc&amp;action=showdarkroom">小黑屋</a><span class="pipe">|</span> <strong><a href="$_G['setting']['siteurl']" target="_blank">$_G['setting']['sitename']</a></strong>
        <!--{hook/global_footerlink}--> 
        <!--{if $_G['setting']['statcode']}-->$_G['setting']['statcode']<!--{/if}--> 
      </p>
      <p>Powered by <a href="http://www.adminbuy.cn" target="_blank" style="color: #888888;">Discuz模板</a> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}--> 
        &copy; 2001-2013 <a href="http://www.henhaixiu.com" target="_blank" style="color: #888888;">多玩图库</a><!--{if $_G['setting']['icp']}--> <a href="http://www.miitbeian.gov.cn/" target="_blank" style="color: #888888;">$_G['setting']['icp']</a><!--{/if}--> </p>
