...
<!--推荐板块-->
		<div class="bm"> 
			...
			<ul class="tt_forum_tjbk">
            	<!--[diy=tt_forum_tjbk]--><div id="tt_forum_tjbk" class="area"></div><!--[/diy]-->
			</ul>       
		</div>       
<!--签到-->              
...
<!--精彩推荐-->
	<div class="bm tt_jctj">
        ...
        <div class="bm_c">
        	<!--[diy=tt_forum_jctj]--><div id="tt_forum_jctj" class="area"></div><!--[/diy]-->
        </div>
   	</div> 
<!--明星用户--> 
	<div class="bm tt_mxyh">
        ...
        <div class="bm_c">        	
            <ul>
            	<!--[diy=tt_forum_mxyh]--><div id="tt_forum_mxyh" class="area"></div><!--[/diy]-->
            </ul>
        </div>
   	</div>
<!--{/if}-->
