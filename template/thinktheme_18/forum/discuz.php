...
<div id="pt" class="bm cl">
  <!--{if empty($gid) && $announcements}-->
    ...
    <div class="z">
        ...
        $navigation
        <!--{if !isset($_G['forum']['name'])}--><em>&rsaquo;</em><a href="forum.php">所有版块</a><!--{/if}-->
    </div>
...
<div id="ct" class="wp cl ct2">
	...
	<div class="mn">
	<!--{if empty($gid)}-->
<div class="tt_chart" style="position: relative;height:40px;">
	<p>
        <span class="ico-info"></span>
        <span class="gray">{lang index_today}:</span> $todayposts
        <em>|</em>
        <span class="gray">{lang index_yesterday}:</span> $postdata[0]
        <em>|</em>
        <span class="gray">{lang index_posts}:</span> $posts
        <em>|</em>
        <span class="gray">{lang index_members}:</span> $_G['cache']['userstats']['totalmembers']
        <!--{if $_G['cache']['userstats']['newsetuser']}-->
        <em>|</em>
        <span class="gray">{lang welcome_new_members}:</span> <a href="home.php?mod=space&username={echo rawurlencode($_G['cache']['userstats']['newsetuser'])}" target="_blank" class="bluelink">$_G['cache']['userstats']['newsetuser']</a>
        <!--{/if}-->
    </p>
</div>
<!--{/if}-->
		...
		<!--{loop $catlist $key $cat}-->
			...
			<div class="bm bmw br4 {if $cat['forumcolumns']} flg{/if} cl">
				<div class="bm_h cl">
					<span class="o">
							...
							<td class="fl_g" width="$cat[forumcolwidth]" style="padding:10px;">
								...
								<dl{if !empty($forum[extra][iconwidth]) && !empty($forum[icon])} style="margin-left: {$forum[extra][iconwidth]}px;"{/if}>
									...
									<!--{/if}-->
                                     ...
                                     <!--{if empty($forum[redirect])}--><dd class="sidea_postsnum"><em>{lang forum_threads} : <!--{echo dnumber($forum[threads])}--></em> <span>|</span> <em>{lang forum_posts} : <!--{echo dnumber($forum[posts])}--></em></dd><!--{/if}-->
...
<!--板块排行-->
<div class="bm tt_bm_hot">
		
        <div id="test2_1">
			<ul>
				<!--[diy=tt_bbs_bkph]--><div id="tt_bbs_bkph" class="area"></div><!--[/diy]-->
			</ul>
        </div>
...
<!--精彩推荐-->
	<div class="bm tt_jctj">
        ...
        <div class="bm_c">
        	<!--[diy=tt_bbs_jctj]--><div id="tt_bbs_jctj" class="area"></div><!--[/diy]-->
        </div>
   	</div>     
...
<!--热门排行--> 
	<div class="bm tt_rmph">
        ...
        <div class="bm_c">        	
            <ul>
            	<!--[diy=tt_bbs_rmph]--><div id="tt_bbs_rmph" class="area"></div><!--[/diy]-->
            </ul>
        </div>
   	</div>
...
<!--明星用户--> 
	<div class="bm tt_mxyh">
        ...
        <div class="bm_c">        	
            <ul>
            	<!--[diy=tt_bbs_mxyh]--><div id="tt_bbs_mxyh" class="area"></div><!--[/diy]-->
            </ul>
        </div>
   	</div> 
...
<!--关注我们--> 
	<div class="bm tt_rmph">
        ...
        <div class="bm_c">        	
            	<!--[diy=tt_BBSguanzhu]--><div id="tt_BBSguanzhu" class="area"></div><!--[/diy]-->
        </div>
   	</div>
