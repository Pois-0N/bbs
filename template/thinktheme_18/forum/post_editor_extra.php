...
<div class="pbt cl">
	...
	<!--{if $isfirstpost && !empty($_G['forum'][threadtypes][types])}-->
		<div class="ftid">
			...
			<select name="typeid" id="typeid" width="80" height="30">
	...
	<div class="z">
		...
		<!--{else}-->
			<!--{if $_GET[action] != 'reply'}-->
				<span class="tt_post_s"><input type="text" name="subject" id="subject" class="px" value="$postinfo[subject]" {if $_GET[action] == 'newthread'}onblur="if($('tags')){relatekw('-1','-1'{if $_G['group']['allowposttag']},function(){extraCheck(4)}{/if});doane();}"{/if} onkeyup="strLenCalc(this, 'checklen', 80);" style="width: 25em" tabindex="1" /></span>
			<!--{else}-->
