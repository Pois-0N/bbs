<?PHP exit('10配色小米完美版 GBK AB模板网全网首发 - http://www.adminbuy.cn');?>
	</div>
...
<div id="scrolltop" style="visibility:hidden;">
    ...
    <span><a href="javascript:;" id="newspecial" {if !$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']} onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=$_G[fid]')"{else} onclick="location.href='forum.php?mod=post&action=newthread&fid=$_G[fid]';return false;"{/if} title="{lang send_posts}" class="postfast">快速发帖</a></span>
